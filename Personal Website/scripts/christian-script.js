const HEART = [false, false, false, false, false];
const COMMENT = [false, false, false, false, false];
const SHARE = [false, false, false, false, false];
...
function showDescription(num) {
    ...
    switch (num) {
        ...
        case 9:
            ...
            break;
        case 10:
            text.innerHTML = 'Become the Vice-President of the Information and Communications Technology 2021-2023';
...
setInterval(() => {
    ...
    setTimeout(() => {
        switch (ctr) {
        case 0:
            changeRole("Developer of Arduino.");
